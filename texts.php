...
#                    <br>",
    ...
    "info_groups" => "
                    <p>
                        <b>Inviter venner og kjemp i bander!</b><br>
                        Gjør quizen enda morsommere ved å invitere venner, kollegaer og familie!
                        Opprett eller bli med i en <b>bande</b> for å se hvem som er best.
                        Gå til <a href=\"" . getBaseUrl() . "profile.php\">profilen din</a> for å administrere grupper.<br>
                        Husk å invitere alle du kjenner til Quiz-kalenderen. <br>
                    </p>",
    "info_questions" => "
                    <p>
                        Har du spørsmål eller oppdaget en feil? Ta kontakt på post@josvik.no.
                    </p>",
    "info_rules" => "<p>
                        <b>Regler:</b><br>
                        <ul>
                            <li>Deltakere må registrere seg med en gyldig e-postadresse.</li>
                            <li>Deltakere må velge brukernavn og eventuelt navn på bande (gruppe). Disse vil vises på resultatlistene.</li>
                            <li>Navn som inneholder støtende ord er ikke tillatt.</li>
                            <li>Hver deltaker kan kun ha én bruker. Dobbel registrering er ikke tillatt.</li>
                            <li>Bruteforcing (systematisk forsøke flere svar enn tillatt for hver oppgave) er ikke tillatt.</li>
                            <li>Alle oppgaver har tydelige svar når oppgaven løses, gjetting er ikke nødvendig.</li>
                            <li>Andre former for juks, som deling av svar eller uautorisert bruk av automatiserte verktøy, er ikke tillatt.</li>
                            <li>Forsøk på juks kan føre til gult kort (advarsel) eller rødt kort (diskvalifisering), flere gule kort kan gi rødt kort.</li>
                        </ul>
                    </p>",
    "info_" => "",
];
